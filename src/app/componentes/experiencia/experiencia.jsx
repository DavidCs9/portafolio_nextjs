    ...
    <motion.section
      ...
      <div className=' text-white pt-6 text-left'>
        ...
        <motion.ul
          ...
          <motion.li
          >Apoyo requerimientos en ORACLE Forms y Reports</motion.li>
          <motion.li
          >Apoyo en creacion y mantenimiento de servicios web</motion.li>
          <motion.li
          >Investigacion para mejoras en procesos enfocados en TI</motion.li>
        </motion.ul>
      </div>
